...
//内核对象
extern OS_Q   					g_queue_msg;			//消息队列的对象
extern OS_Q   					g_queue_led1;			//消息队列的对象
extern OS_Q   					g_queue_led2;			//消息队列的对象
extern OS_Q   					g_queue_connect;		//消息队列的对象


extern OS_MUTEX					g_mutex_printf;			//互斥锁的对象
extern OS_MUTEX					g_mutex_led_value;		//互斥锁的对象
